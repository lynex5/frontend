...
import { playBoot, playSuccess } from './utils/sound';
...
function Navigation() {
  ...
  return (
    <>
      <nav>
        <GlitchLink to="/" onClick={() => playSuccess()} className="nav-brand nav-item">RAHUL</GlitchLink>
        
        <button className="mobile-hamburger" onClick={() => { playSuccess(); setMobileMenuOpen(true); }}>[ ≡ ]</button>
        
        <div className="nav-links">
          <GlitchLink to="/work" onClick={() => playSuccess()} className={`nav-item ${location.pathname.startsWith('/work') ? 'active' : ''}`}>Work</GlitchLink>
          <GlitchLink to="/about" onClick={() => playSuccess()} className={`nav-item ${location.pathname === '/about' ? 'active' : ''}`}>About</GlitchLink>
          <GlitchLink to="/potd" onClick={() => playSuccess()} className={`nav-item ${location.pathname === '/potd' ? 'active' : ''}`}>POTD</GlitchLink>
          <GlitchLink to="/contact" onClick={() => playSuccess()} className={`nav-item ${location.pathname === '/contact' ? 'active' : ''}`}>Contact</GlitchLink>
          {!token && <GlitchLink to="/login" onClick={() => playSuccess()} className={`nav-item ${location.pathname === '/login' ? 'active' : ''}`}>Login</GlitchLink>}
          {token && <GlitchLink to="/dashboard" onClick={() => playSuccess()} className={`nav-item nav-dashboard ${location.pathname === '/dashboard' ? 'active' : ''}`}>DASHBOARD</GlitchLink>}
      ...
      {mobileMenuOpen && (
        <div className="mobile-menu-fullscreen">
          ...
          <div className="mobile-menu-links">
            <GlitchLink to="/" onClick={() => { playSuccess(); closeMenu(); }}>&gt; HOME</GlitchLink>
            <GlitchLink to="/work" onClick={() => { playSuccess(); closeMenu(); }}>&gt; WORK</GlitchLink>
            <GlitchLink to="/about" onClick={() => { playSuccess(); closeMenu(); }}>&gt; ABOUT</GlitchLink>
            <GlitchLink to="/potd" onClick={() => { playSuccess(); closeMenu(); }}>&gt; POTD</GlitchLink>
            <GlitchLink to="/contact" onClick={() => { playSuccess(); closeMenu(); }}>&gt; CONTACT</GlitchLink>
            {!token && <GlitchLink to="/login" onClick={() => { playSuccess(); closeMenu(); }}>&gt; LOGIN</GlitchLink>}
            {token && <GlitchLink to="/dashboard" onClick={() => { playSuccess(); closeMenu(); }}>&gt; DASHBOARD</GlitchLink>}
